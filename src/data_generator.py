...
def main(args):
	...
	post_ques_ans_tsv_file = open(args.post_ques_ans_tsv, 'w')
	post_ques_ans_tsv_file.write('postid\ttitle\tpost\tquestion\tanswer\n')
	for postId in post_ques_answers:
		post_ques_ans_tsv_file.write('%s\t%s\t%s\t%s\t%s\n' % (postId, \
...
if __name__ == "__main__":
	...
	argparser.add_argument("--post_ques_ans_tsv", type = str)
